...
<body id="body">
    ...
    <div class="menu__side" id="menu_side">
        ...
        <div class="name__page">
            <i><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#ffffff" viewBox="0 0 256 256">
                    <path
        ...
        <div class="options__menu">
            ...
            <a href="{{route('home')}}">
                <div class="option">
                    <i class="" title="Reportes"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
            ...
            <a href="{{route('citas')}}" class="selected">
                <div class="option">
                    <i title="Citas"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#ffffff"
                            viewBox="0 0 256 256">
                            <path
            ...
            <a href="{{route('empleados')}}">
                <div class="option">
                    <i title="Empleados"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#ffffff"
                            viewBox="0 0 256 256">
                            <path
            ...
            <a href="{{route('historial')}}">
                <div class="option">
                    <i title="Historial"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#ffffff"
                            viewBox="0 0 256 256">
                            <path
    ...
    <div class="container-fluid d-flex justify-content-center p-md-3 p-lg-3 h-100">
        <div class="row  col-12 col-lg-11 h-auto">
            ...
            <div class="col-12 d-flex flex-column">
                ...
                <input type="text" class="w-100 w-100 form-check-input">
            </div>
            ...
            <div class="col-12 d-flex flex-column">
                <label for="" class="">Reparacion</label>
                <input type="text" class="w-100 form-check-input">
            </div>


            <div class="col-12 d-flex flex-column pb-3">
                <label for="" class="">Vehiculo</label>
                <input type="text" class=" w-100 form-check-input">
            </div>

            <div class="col-12 d-flex justify-content-end pb-3">
<button class="w-25 btn-secondary" type="submit">Registrar</button>
            </div>
        </div>
    </div>
