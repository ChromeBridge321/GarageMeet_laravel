    ...
    <div class=" collapse w-100 position-fixed col-12 bg-black pt-5 mt-5" id="collapseExample">
        <div class="card w-100 bg-black border-0">
            <div class="col-sm-12 d-flex align-items-center justify-content-center links pt-5">
                <a class="underline-hover" href="{{ route('talleres') }}">Talleres</a>
            </div>


            <div class="col-sm-12 col-md d-flex align-items-center justify-content-center links">
                <a class="underline-hover" href="#Nosotros">Nosotros</a>
            </div>


            <div class="col-sm-12 col-md d-flex align-items-center justify-content-center links">
                <a class="underline-hover" href="#Planes">Planes</a>
            </div>



            <div class="col-sm-12 d-flex align-items-center justify-content-center links">
                @if (Route::has('login'))
                    @auth
